// C program that implements a producer-consumer system with two processes using Semaphores.// C program that implements a producer-consumer system with two processes using Semaphores.
#include <stdio.h>      
#include <stdlib.h>     
#include <unistd.h>     
#include <sys/types.h>  
...
int main() {
    ...
    if (child_pid == 0) {  
       ...
       // Wait for child to finish
        ...
        printf("Press Enter to remove semaphore...\n");
        getchar();
